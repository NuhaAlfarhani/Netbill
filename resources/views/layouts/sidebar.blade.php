        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('bills') ? 'active' : '' }} ">
                    <a href="{{ route('bills') }}" class='sidebar-link'>
                        <i class="bi bi-receipt"></i>
                        <span>Tagihan</span>
                    </a>
                </li>
                
                <li class="sidebar-item {{ request()->routeIs('packages') ? 'active' : '' }} ">
                ...
                <li class="sidebar-item {{ request()->routeIs('mikrotik') ? 'active' : '' }} ">
                    <a href="{{ route('mikrotik') }}" class='sidebar-link'>
